...
| 项目 | Stars | 说明 |
|------|-------|------|
| [awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules) | 15k+ | Cursor 专用规则合集（最早的） |
| [awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | — | Claude Code 的技能、钩子、斜杠命令集 |
| [awesome-claude-code](https://github.com/jqueryscript/awesome-claude-code) | — | Claude Code 工具和 IDE 集成 |
| [awesome-claude-code-subagents](https://github.com/VoltAgent/awesome-claude-code-subagents) | — | 100+ Claude Code 专用子代理 |

### Agent 编排框架

| 项目 | 说明 |
|------|------|
| [Conductor](https://github.com/cyq1017/conductor) | 多 AI 编程 Agent 协作治理 CLI — 结构化交接、信任校准 |
...
| [Anthropic: CLAUDE.md 指南](https://docs.anthropic.com/en/docs/claude-code) | Claude Code 如何读取 CLAUDE.md 的官方文档 |
...
#### 分层记忆架构
```
系统/全局层  →  ~/.claude/CLAUDE.md, ~/.gemini/AGENTS.md
项目层      →  ./CLAUDE.md, ./AGENTS.md
会话层      →  HANDOFF.md, task.md, 临时文件
```

#### "错误法则"
> 如果从 CLAUDE.md 中删掉一行，Agent 也不会因此犯错——那就删掉它。
...
| **概述** | 1-2句：这个项目是什么 | 2 行 |
| **技术栈** | 语言、框架、核心库 | 5 行 |
| **命令** | dev, test, build, deploy | 5-10 行 |
| **架构** | 关键目录和逻辑位置 | 10-15 行 |
| **规则** | 项目特定的行为约束 | 10-20 行 |
| **总计** | | **< 200 行** |

> 💡 在 Claude Code 中运行 `/init` 可自动生成初始 CLAUDE.md。
